...
CFLAGS = -std=gnu99 -I. -I$(INC_DIR) -Ilibesphttpd/include -Werror -Wpointer-arith -Wundef -Wall -mlongcalls -DUSE_OPENSDK -DICACHE_FLASH -DWIFI_SSID=\"${WIFI_SSID}\" -DWIFI_PASS=\"${WIFI_PASS}\" -Wl,-EL -fno-inline-functions -nostdlib -mtext-section-literals -Wno-address -Werror -Wpointer-arith -ggdb -Os -ffunction-sections -fdata-sections
...
libesphttpd: libesphttpd/Makefile
	...
	$(Q) make -C libesphttpd USE_OPENSDK=yes HTTPD_WEBSOCKETS=no
